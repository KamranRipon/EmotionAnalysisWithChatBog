<template>
  <div div class="negative-survey">
    <h1>Negative Emotion</h1>
    ...
    <div class="button-container">
      <button @click="submitSurvey" class="submit-button">Analyze</button>
...
export default {
  data() {
    return {
      questions: ['Sadness', 'Anxiety', 'Frustration'],
      answers: [0, 0, 0],
    };
  },
  methods: {
    submitSurvey() {
      ...
      this.$router.push('/AnalysisNegativeEmotionPage');
    },
    goToHome() {
      this.$router.push('/');
    },
